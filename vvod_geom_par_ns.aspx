<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vvod_geom_par_ns.aspx.cs" Inherits="vvod_geom_par_ns" %>
...
<body>
   ...
   <div style="height: 1081px; background-color: #D2D0D2;">
     ...
     <div style="width: 100%; height: 33px; background-color: #999999; font-size: x-large; color: #FFFFFF;">
            ...
            <p style="margin-left: 40px">Ввод геометрических параметров (обработка наружной стороны)</p> 
        ...
        <asp:Button ID="Button2" runat="server" Text="ОК" style="position: absolute; left: 808px; top: 573px; height: 30px; width: 72px;" BackColor="#999999" Font-Size="Medium" OnClick="Button2_Click" />
               
        <asp:Label ID="Label8" runat="server" Text="Label" style="position: absolute; top: 62px; left: 418px;" Font-Bold="True"></asp:Label>
        <asp:Label ID="Label9" runat="server" Text="Label" style="position: absolute; top: 62px; left: 85px; width: 309px; right: 965px;" Font-Bold="True"></asp:Label>
        <asp:Label ID="Errormes" runat="server" style="position: absolute; top: 656px; left: 46px; width: 254px;" Font-Bold="True" ForeColor="Red"></asp:Label>
       ...
       <asp:TextBox ID="TextBox8" MaxLength="3" runat="server" style="position: absolute; top: 240px; left: 227px;" ReadOnly="True" Width="80px"></asp:TextBox>
       <asp:TextBox ID="TextBox9" MaxLength="5" runat="server" style="position: absolute; top: 280px; left: 227px;" ReadOnly="True" Width="80px"></asp:TextBox>
       ...
       <asp:Label ID="Label3" runat="server" Text="- с наружной стороны:" style="position: absolute; top: 358px; left: 44px; width: 391px;" Font-Bold="True"></asp:Label>
       
       <asp:Label runat="server" Text = "Диаметр круга катания, мм <span style= color:red>*</span>" style="position: absolute; left: 53px; top: 372px; width: 204px; margin-top: 17px; height: 20px; right: 515px;"></asp:Label>
       ...
       <asp:Label ID="Label21" runat="server" Text = "Утопание (вылет) ступицы, мм <span style= color:red>*</span>" style="position: absolute; left: 25px; top: 447px; width: 230px; margin-top: 17px; height: 20px;"></asp:Label>
       <asp:Label ID="Label22" runat="server" Text = "Внутренний диаметр обода, мм <span style= color:red>*</span>" style="position: absolute; left: 23px; top: 483px; width: 232px; margin-top: 17px; height: 20px;"></asp:Label>
       ...
       <asp:TextBox ID="TextBox14" MaxLength="2" runat="server" style="position: absolute; top: 462px; left: 269px;" Width="80px"></asp:TextBox>
       <asp:TextBox ID="TextBox15" MaxLength="3" runat="server" style="position: absolute; top: 499px; left: 269px;" Width="80px"></asp:TextBox>
       <asp:CheckBox ID="CheckBox1" runat="server" style="position: absolute; top: 541px; left: 119px;" Text="Диаметр ступицы" TextAlign="Left"/>
